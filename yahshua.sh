...
<head>
  ...
  <style>
    body,h1,h3 {font-family: "Times New Roman", sans-serif}
    body, html {height: 100%}
    .bgimg {
      background-image: url('https://i.pinimg.com/originals/9b/fa/1e/9bfa1e1948eff974d56fe3cecca0a0e9.jpg');
      min-height: 100%;
...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://giphy.com/embed/koPZEcZ0inEIg"
              width="480"
              height="240"
    ...
    <div class="w3-display-bottomleft w3-padding-small transparent-background outlined-text">
      ...
      <h2>Migration Job on the 9th<h2>
